...
export default {
  ...
  auth: {
    ...
    register: {
      ...
      errors: {
        ...
        inviteCodeCreateFailed: 'Davet kodu oluşturulamadı, tekrar dene.',
        inviteCodeNotFound: 'Davet kodu bulunamadı. Kodu kontrol edip tekrar dene.',
      },
    },
  },
  home: {
  ...
  notifications: {
    ...
    doseReady: '{childName} için {name} zamanı geldi.',
    doseReadyGeneric: '{name} için ilaç zamanı geldi.',
    courseStartReady: '{childName} için {name} kürü başlıyor.',
    courseStartReadyGeneric: '{name} kürüne başlama zamanı geldi.',
    courseEndReady: '{childName} için {name} kürü sona erdi.',
    courseEndReadyGeneric: '{name} kürü sona erdi.',
    reminderReady: '{childName} için {name} zamanı geldi.',
    reminderReadyGeneric: '{name} için ilaç zamanı geldi.',
